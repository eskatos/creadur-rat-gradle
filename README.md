...
| Plugin   | Min Java                   | Min Gradle | Max Gradle | Configuration Cache (1) | Isolated Projects (2) | Build Cache (3) |
|----------|----------------------------|------------|------------|-------------------------|-----------------------|-----------------|
...
* (2) [Isolated Projects](https://docs.gradle.org/current/userguide/isolated_projects.html), on Gradle `7.1` and later
